      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(color: scheme.onPrimaryContainer.withValues(alpha: 0.72)),
          ),
          const SizedBox(height: 18),
          FilledButton.icon(
            onPressed: onStart,
          ...
          children: [
            Row(
              children: [
                ...
                Text('${snapshot.todayCompletedMinutes} / $goal ${strings.minutes}', style: Theme.of(context).textTheme.labelLarge?.copyWith(fontWeight: FontWeight.w800)),
              ],
            ),
