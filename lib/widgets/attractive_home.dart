            ...
            children: [
                  ...
                  children: [
                    Expanded(
                      child: _StatCard(
                        ...
                        label: strings.isBangla ? 'দিন স্ট্রিক' : 'day streak',
                      ),
                    ),
                    ...
                    Expanded(
                      child: _StatCard(
                        ...
                        label: strings.isBangla ? 'লেভেল' : 'level',
                      ),
                    ),
                  ],
                ),
              ...
              if (snapshot.plan == null)
                ...
                ...snapshot.plan!.items.asMap().entries.map((entry) {
                  ...
                  final completed =
                      widget.store.itemCompletedMinutesMap[entry.key] ?? 0;
                  final progress = item.minutes <= 0
                      ? 1.0
                      : (completed / item.minutes)
                          .clamp(0.0, 1.0)
                          .toDouble();
                  final active =
                      snapshot.currentIndex == entry.key && snapshot.hasRemainingWork;
              ...
              _AnimatedSection(
                ...
                child: _SectionTitle(
                  strings.isBangla ? 'স্টাডি মোড' : 'Study modes',
                ),
              ),
              const SizedBox(height: 12),
              _AnimatedSection(
              ...
              _AnimatedSection(
                ...
                child: _ModeCard(
                  ...
                  title: strings.isBangla
                      ? 'পরীক্ষার প্রস্তুতি'
                      : 'Exam Preparation',
                  subtitle: strings.isBangla
                      ? 'অগ্রাধিকার অনুযায়ী রিভিশন করুন।'
                      : 'Revise by priority.',
                  onTap: () => widget.onExam(false),
                ),
              ),
              _AnimatedSection(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            '${snapshot.remainingMinutes} ${strings.minutes} left',
            style: TextStyle(
          ...
          const SizedBox(height: 5),
          Text(
            '${snapshot.plan?.allocatedMinutes ?? 0} ${strings.minutes} planned • ${snapshot.estimatedFocusBlocksRemaining} ${strings.isBangla ? 'ব্লক বাকি' : 'blocks left'}',
            style: TextStyle(
              ...
              child: FilledButton.icon(
                ...
                label: Text(
                  snapshot.isComplete
                      ...
                      : (strings.isBangla ? 'শুরু করুন' : 'Start'),
                ),
              ),
            ),
          ),
          ...
          children: [
            Row(
              children: [
                ...
                Text(
                  '${snapshot.todayCompletedMinutes} / $goal ${strings.minutes}',
            ...
            Text(
              snapshot.dailyGoalReached
                  ? (strings.isBangla
                      ? 'লক্ষ্য পূর্ণ। গতি ধরে রাখুন।'
                      : 'Goal reached. Keep the momentum.')
                  : '${snapshot.goalRemainingMinutes} ${strings.minutes} ${strings.isBangla ? 'বাকি আজ' : 'left today'}',
            ),
          ],
        ),
      ),
